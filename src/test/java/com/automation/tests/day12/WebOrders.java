...
public class WebOrders {
    ...
    * */
    ...
    public void test3(){
        ...
        WebElement productSelection = driver.findElement(By.id("ctl00_MainContent_fmwOrder_ddlProduct"));
        ...
        String expected = "Mesut Ali";
        String actual = driver.findElement(By.xpath("//*[@id=\"ctl00_MainContent_orderGrid\"]/tbody/tr[2]/td[2]")).getText();
